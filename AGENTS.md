...
10. Дотримуватись канонічного неймінґу: `Квестарня` для гравців, `kvestarnia` для технічних ідентифікаторів. Не використовувати `Questarnia`, `Квестарнія`, `Kvestarnya`.
11. Не вставляти секрети, токени, приватні chat_id або реальні ключі в код/доки.
12. Не ламати існуючі міграції. Нові зміни схеми — через нову міграцію.
13. Усі ігрові розрахунки мають бути детермінованими та тестованими: бойова логіка не повинна залежати від Telegram API.
14. Повідомлення Telegram тримати короткими: 1 екран на мобільному, кнопки для дій, деталі — за запитом.
15. Не робити pay-to-win механіки. Монетизація може давати косметику, комфорт або підтримку сервера, але не безчесну бойову перевагу.
16. Після зміни логіки запускати тести або пояснити, чому не вдалося.
