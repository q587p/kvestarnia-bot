...
12. In visible docs/changelog/news/player dates, use the Holocene calendar: `12026`, not `2026`. Release/news/changelog date headings use Kyiv time (`Europe/Kyiv`) and the fixed Holocene `YYYY-MM-DD` format, for example `12026-06-19`. Do not rewrite machine timestamps, migration names, or technical IDs.
