...
CREATE INDEX "group_combat_sessions_status_terminal_integrity_checked_at_updated_at_id_idx" ON "group_combat_sessions"("status", "terminal_integrity_checked_at", "updated_at", "id");
