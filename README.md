...
- `/tavern` і `/raid` відкривають малий solo-рейд «П’ятничний рейд на Бочку Пінного Міражу» з винагородою раз на локальний день; після рейду можна витратити золото через `🍻 Всім пива`.
...
9. Після рейду натисніть `🍻 Всім пива`: має списатися 100 золота за якісне пиво, 10 за просте або з’явитися жарт про нестачу золота.
