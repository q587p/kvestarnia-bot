...
9. Перейдіть до `📋 Стіл зі справами` або відкрийте `/quest` усередині корчми.
10. Натисніть `🌯 До шаурми` або відкрийте `/adventure`, тоді оберіть одну дію проти `Міміка-шаурми`: тицьнути, попросити чек або відступити.
11. Натисніть `⚔️ До сутички` або відкрийте `/fight` чи `/hunt`.
12. Оберіть одну дію в «Сутичці з Міміком-шаурмою»: вдарити, збити з пантелику чеком або відступити красиво.
13. Коли денні шаурма й сутичка витрачені, відкрийте `/quest` або кнопку `🗺️ Квест` усередині корчми: hub має лишити доступною «Підвальну справу».
