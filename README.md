...
Підтримка не дає XP, золота, манаток, рівнів, доступу до фіч або переваг. Deep link подяки `/start barrel_thanks` показує тільки косметичний «Тост із Бочки» і не підтверджує оплату.
