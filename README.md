...
**Квестарня** — україномовна RPG у Telegram: створюєш пригодника, заходиш у корчму, береш квест, б’єш дурнуватих монстрів, збираєш манатки й ростеш по рівнях.
...
- `/hunt` — Єгерська справа з 4 рівня: перший квест `Неспокійні справи`, прогрес через won persistent solo-бій і одноразова нагорода за 5 неупокоєних цілей.
...
- `/inventory`, `/items`, `/bag` — persistent манатки пригодника з деталями, категоріями, вартістю, сумою всіх priced речей у торбі й Дружньою Скринею для переробки зайвого.
...
- у контенті вже є перший бестіарій на 20 чудовиськ і трофеїв; частина цього списку виходить у runtime через read-only бестіарій, Єгерські цілі для `/hunt` і persistent solo `/fight` із контрольованим reward/loot path.
