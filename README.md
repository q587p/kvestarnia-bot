...
У боті є вторинна команда `/support`: якщо runtime-оточення має налаштовану `Бочку підтримки Квестарні`, вона покаже добровільне посилання й, за наявности ручних статусних полів, спокійний стан Бочки. Якщо посилання не налаштоване, команда чесно скаже, що Бочку ще прибивають до дошки.

Підтримка не дає XP, золота, луту, манаток, рівнів, бойової сили, прогресу або доступу до фіч. Deep link подяки `/start barrel_thanks` показує тільки косметичний «Тост із Бочки» і не підтверджує оплату.
...
- [`docs/phase2/SOCIAL_COMBAT_PLAN.md`](docs/phase2/SOCIAL_COMBAT_PLAN.md) — Phase 2 roadmap reset: запрошення на дуель, картки результатів, подарунки/обміни, `/remort`, кілька ворогів і гуртові бої.
