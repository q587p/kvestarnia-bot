...
Підтримка не дає XP, золота, луту, манаток, рівнів, бойової сили, прогресу або доступу до фіч. Deep link подяки `/start barrel_thanks` показує тільки косметичну сцену подяки й не підтверджує оплату.
