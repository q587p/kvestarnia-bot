...
`0.1.x` закрито в `0.1.25` як Phase 2 Social Combat MVP: тренування, opt-in дуелі, реванші, картки результатів, запрошення поруч, бойові замки, памʼять проходів у Низі й перший обережний економічний зріз Шинку вже утворюють завершену ранню соціяльну петлю. Наступна лінійка `0.2.x` починається з безпечних подарунків однієї придатної манатки, а кілька ворогів, item tags, ширше спорядження, гуртові бої й справжні рейди лишаються наступними кроками, не вже відкритими кнопками.
