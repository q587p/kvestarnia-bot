...
- `/fight` — безпечна бойова перевірка з підозрілим монстром без повної persistent combat state machine.
- `/hunt` — Дошка полювання з щогодинним контрактом на монстра з бестіарію.
...
- у контенті вже є перший бестіарій на 20 чудовиськ і трофеїв; частина цього списку виходить у runtime через Дошку полювання й read-only бестіарій, але повний бойовий рушій ще не ввімкнений.
