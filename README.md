...
- `/inventory`, `/items`, `/bag` — persistent манатки героя з коротким оглядом і вартістю.
- `/equipment`, `/gear`, `/equip` — вітрина спорядження й гачки для майбутніх бонусів без зміни статів.
