...
export const configSchema = z.object({
  ...
  leftPassagePartyAttackEnabled: z.boolean().default(false),
  guildFoundationEnabled: z.boolean().default(false),
  guildWeeklyGoalEnabled: z.boolean().default(false),
  referralFoundationEnabled: z.boolean().default(false),
  referralRewardPayoutsEnabled: z.boolean().default(false),
...
export function loadConfig(env: NodeJS.ProcessEnv = process.env): AppConfig {
  return configSchema.parse({
    ...
    leftPassagePartyAttackEnabled: parseBoolean(env.LEFT_PASSAGE_PARTY_ATTACK_ENABLED),
    guildFoundationEnabled: parseBoolean(env.GUILD_FOUNDATION_ENABLED),
    guildWeeklyGoalEnabled: parseBoolean(env.GUILD_WEEKLY_GOAL_ENABLED),
    referralFoundationEnabled: parseBoolean(env.REFERRAL_FOUNDATION_ENABLED),
    referralRewardPayoutsEnabled: parseBoolean(env.REFERRAL_REWARD_PAYOUTS_ENABLED),
