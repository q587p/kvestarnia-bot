...
export function presentKorchmaYard(_character: CharacterSummary): string {
  ...
  return [
    ...
    "",
    "Під навісом Маг облаштував <i>Чароковальню</i>: банку з Іскрокаменем, молот, товсту рукавицю й табличку «іскри не гладити». Задвірок нарешті має мешканця, який офіційно свариться з манатками.",
    "",
    "Що робимо?"
  ].join("\n");
}
