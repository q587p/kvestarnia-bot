...
export function presentKorchmaYard(_character: CharacterSummary): string {
  ...
  return [
    ...
    "",
    "Під навісом Маг облаштував <i>Чароковальню</i>: банку з Іскрокаменем, молот і табличку «не лизати іскри». Поруч дрібниці Корчмарського обходу чекають, якщо сьогодні дійшли саме сюди.",
    "",
    "Що робимо?"
  ].join("\n");
}
