...
const SUPPORT_DEVELOPER_LINE =
  "Банка підтримки допомагає автору @q587p тримати Квестарню живою: сервер, токени для Кодексу, тексти, редактура, коректура й інші корчмарські витрати.";
...
export function presentSupportJar(
  ...
  if (!supportJarUrl) {
    return [
      ...
      "",
      "Квестарня безкоштовна й не продає силу, лут або прогрес. Коли Банка відчиниться, тут буде добровільне посилання.",
      "",
      SUPPORT_DEVELOPER_LINE,
      "",
  ...
  return [
    ...
    "",
    "Якщо хочете підтримати розробку — можна добровільно підкинути монет у Банку.",
    "",
    SUPPORT_DEVELOPER_LINE,
    "",
    NO_GAMEPLAY_ADVANTAGE_LINE,
