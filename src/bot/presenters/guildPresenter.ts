...
export function presentGuildInviteCreate(
  ...
  const text: Record<string, string> = {
    ...
    "no-character": "Спершу створіть пригодника через /start.",
    "not-member": [
      "✉️ Це посилання не приєднує вас до ґільдії власника картки.",
      "",
      "Воно потрібне <b>голові або старшині</b>: вони відкривають його, щоб запросити власника картки до своєї ґільдії.",
      "",
      "Ви зараз не належите до ґільдії, тому не можете надіслати це запрошення. Якщо хочете вступити самі, відкрийте <b>🏰 До ґільдії</b>, створіть власну картку й передайте її голові або старшині обраної ґільдії."
    ].join("\n"),
    forbidden: [
      "✉️ Посилання відкрито правильно, але запрошувати до ґільдії можуть лише <b>голова або старшина</b>.",
      "",
      "Ваша поточна роль не має такого повноваження. Передайте це саме посилання голові або старшині своєї ґільдії — вони зможуть запросити власника картки."
    ].join("\n"),
