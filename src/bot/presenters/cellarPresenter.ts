...
function presentCellarGrownupAlreadyCompleted(
  ...
  const endingLine =
    result.ending === "turn-in"
      ? "Пляшка вже в журналі Корчмаря. Журнал трохи піниться, але підвал більше нічого не вимагає."
      : "Пляшка вже записана за вами. Підвал визнав це фіналом і пішов робити вигляд, що він завжди був спокійний.";
