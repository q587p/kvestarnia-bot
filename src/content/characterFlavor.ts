...
function classRaidTips(): Record<string, string[]> {
  return {
    ...
    "class.varenyk-mancer": [
      "Тісто добре глушить бризки, але потім вимагає статусу героїчного інвентарю.",
...
function universalRaidTips(): Record<string, string[]> {
  return {
    general: [
      ...
      "Героїчний вигляд тримайте до кінця. Навіть якщо кінець тимчасово тримає вас.",
...
function rangerUniversalActions(): Record<string, string[]> {
  return {
    general: [
      ...
      "Єгер примружується на кран і мовчки киває, як людина, що бачила гірші крани й гірших героїв.",
...
function rangerClassActions(): Record<string, string[]> {
  return {
    "class.warrior": ["Єгер оцінює вашу стійку й мовчки прибирає ламкий табурет із траєкторії."],
    "class.mage": ["Єгер накриває кухоль долонею, щойно ви починаєте вимовляти складні склади."],
    "class.bard": ["Єгер тримає ритм пальцем по столу, але робить вигляд, що це просто нерви."],
    "class.rogue": ["Єгер дивиться не на вас, а на місце, де ви, ймовірно, будете через секунду."],
    "class.priest": ["Єгер знімає капюшон на пів пальця, ніби готується поважати майбутнє диво."],
    "class.varenyk-mancer": ["Єгер відсуває серветки подалі від тіста. Він уже бачив, як тісто бере заручників."],
    "class.bureaucramancer": ["Єгер дістає олівець. Якщо буде форма, він хоче бути далеко від графи «свідок»."],
    "class.ranger": ["Єгер у кутку дивиться на єгеря в рейді. У повітрі стає забагато професійної тиші."],
    "class.kharakternyk": ["Єгер перестає курити на мить. Навіть люлька хоче подивитись, хто кого передивиться."]
  };
}

function rangerRaceActions(): Record<string, string[]> {
  return {
    "race.human-ish": ["Єгер дивиться на вас як на майже нормальний ризик. Найпідозріліший різновид ризику."],
    "race.dwarf": ["Єгер ставить кухоль нижче, ніби поважає гномську траєкторію удару."],
    "race.elf": ["Єгер непомітно витирає стіл рукавом. Ельфійське несхвалення він відчув наперед."],
    "race.bisyny": ["Єгер затуляє нотатник, щоб бісини не почали правити його терміни."],
    "race.drantohor": ["Єгер повертає стрілку намальованої карти в бік Бочки. Дрантогорські маршрути не дрімають."],
    "race.domovyk": ["Єгер піднімає ноги з підлоги. Домовик у рейді означає, що підлога може мати позицію."],
    "race.dryland-rusalka": ["Єгер перевіряє, чи чайник не став стратегічним об’єктом. З русалками краще завчасно."],
    "race.intellectual-orc": ["Єгер відкладає люльку, ніби готується слухати коротку, але важку доповідь."],
    "race.molfar-soul": ["Єгер дивиться в туман біля ваших плечей і ввічливо не питає, скільки вас там."]
  };
}
