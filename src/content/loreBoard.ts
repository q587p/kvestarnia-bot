...
export const loreEntries: readonly LoreEntry[] = [
  ...
  },
  {
    ...
    body: "Разові манатки не вдягають, а витрачають у слушну мить. Одні підшивають HP чи ману, інші ділять поміч із союзником або цілою ватагою, знімають одну прикрість, кваплять прийоми, завдають певної шкоди чи рятують від найближчої відповіді. Випадковий вміст визначають один раз і не перетрушують після скасування. Поза боєм корисний результат спершу показують для підтвердження; у бою манатка стає дією ходу, а вороги не завжди чемно чекають. Коли нема кого або чого підлатати, запас лишається в торбі. Пляшка Пінного Міражу теж терпляче чекає, доки її долю вирішать у погребі.",
    canonicalRefs: [
