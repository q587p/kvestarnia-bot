...
export const loreEntries: readonly LoreEntry[] = [
  ...
  },
  {
    ...
    title: "Злодій",
    source: "з навчальної полиці класів",
    body: "Злодій зникає швидше, ніж рахунок після походу в корчму. З 3 рівня він може ризикнути «тихою кишенею» по активній цілі поруч: золота мало, сорому публічного нема, а чужий лікоть іноді має дуже переконливу теорію справедливости.",
  ...
  },
  {
    ...
    title: "Жрець",
    source: "з навчальної полиці класів",
    body: "Жрець лікує союзників і суворо дивиться на нежить. З 3 рівня він може допомогти собі або активному пригоднику поруч поза боєм: полікувати маною без бинтів або накласти коротке благословення, яке не складається в стос.",
