...
export const loreCategories: readonly LoreCategory[] = [
  ...
  },
  {
    id: "guilds",
    title: "🏰 Ґільдії",
    description: "Статут, Гніздо, спільні тижневі справи, Слава й те, чого вона не купує.",
    sortOrder: 70
  },
  {
    id: "customs",
...
export const loreEntries: readonly LoreEntry[] = [
  ...
  },
  {
    ...
    source: "польова нотатка з місцини: Корчма Квестарні",
    body: "Стіл зі справами витримує квести, полювання, архіви й бестіарій. Перший папірець тут навчає простого маршруту: зайти до Корчми, дійти до столу й не загубити себе між дверима та справами. Сам стіл би попросив підвищення, але поки що просить тільки не ставити кухлі на папери з написом «терміново».",
  ...
  },
  {
    ...
    source: "польова нотатка з бічної камори при Спуску",
    body: "Від Спуску до Низу вбік відходить низький прохід. За ним — кругла камора з лавами, гербами й поштовими щілинами. Писар називає її канцелярією; пригодники — Гніздом. Тут читають правила статутів і відкриті записи чинних ґільдій, але склади, запрошення й чужі сліди лишаються приватними.",
    canonicalRefs: [{ type: "location", id: "location.korchma.deep" }]
  },
  {
    ...
    body: "Лівий прохід у Сутеренах виглядає так, ніби вже знає вашу помилку наперед. Тут темрява не густа, вона просто добре організована. Після особливо переконливої перемоги прохід ненадовго показує сходи до Ярусу II, але там поки що ремонт, кошториси й жодного дозволу йти далі.",
  ...
  },
  {
    ...
    body: "Воїн має простий план: стояти рівно й переконливо махати залізом. У бою цей план називається «🪓 Силовий замах» і пояснює одній проблемі, чому стояти перед сокирою — погана кар’єра.\n\nПоза самим замахом воїн може тримати по зброї в кожній руці. А в рейді проти Старшого Брата Бочки виклик «🛡️ На мене!» змушує весь гуркіт дивитися в бік найголоснішого щита. Корчмар каже, що це не жадібність до ударів, а симетрична аргументація.",
  ...
  },
  {
    ...
    title: "Бард",
    source: "з навчальної полиці класів",
    body: "Бард перемагає харизмою, куплетами й небезпечною впевненістю. У бою «🎶 Небезпечний куплет» чіпляє всіх ворогів і лишає союзникам моральний піджак на плечах.\n\nУ шинку бард може виступити для активної публіки поруч, а слухачі — добровільно лишити чайові. «✨ Натхнення» від виступу не залежить від оплати. У рейді на Старшого Брата Бочки «🎻 Журлива балада» послаблює його відповідь, доки табурети тримають моральний стрій.",
  ...
  },
  {
    ...
    title: "Вареник-мант",
    source: "з навчальної полиці класів",
      body: "Вареник-мант керує тістом, настроєм і легким відчуттям ситости. У бою «🥟 Кипляча начинка» бризкає по ворогах, а пара трохи зцілює пригодника, бо навіть магія любить, коли всередині тепло.\n\nВід 3 рівня він може «🍽️ Нагодувати» себе або активного пригодника поруч. Миска одразу підбадьорює HP, а короткий стан «😋 Ситий» потім підтримує HP і ману порціями, сила яких залежить від самої миски, — щохвилини поза боєм або кожен хід в бою (це забирає хвилину дії). Свіжа миска іншого Вареник-манта може перевести кухонний годинник наново: вареники ситні, але не безмежні.",
  ...
  },
  {
    ...
    title: "Бюрокромант",
    source: "з навчальної полиці класів",
    body: "Бюрокромант знерухомлює ворогів формами, печатками й дуже серйозним виглядом. У бою «📄 Форма 13-А» змушує кожного ворога тимчасово виглядати як помилка заповнення, а під час збору до Старшого Брата Бочки «Протокол 13-З» може прийняти перший персональний ляпас по підписанту.",
  ...
  },
  {
    ...
    body: "Разові манатки не вдягають, а витрачають у слушну мить. Одні підшивають HP чи ману, інші ділять поміч із союзником або цілою ватагою, знімають одну прикрість, кваплять прийоми, завдають певної шкоди чи рятують від однієї найближчої відповіді — наступні вороги не забувають своєї черги. Випадковий вміст визначають один раз і не перетрушують після скасування. Поза боєм корисний результат спершу показують для підтвердження; у бою манатка стає дією ходу, а вороги не завжди чемно чекають. Коли нема кого або чого підлатати, прийом уже готовий чи відповідь летить в іншого пригодника, запас лишається в торбі. Пляшка Пінного Міражу теж терпляче чекає, доки її долю вирішать у погребі.",
    canonicalRefs: [
      { type: "item", id: "item.responsible-panic-bandage" },
      { type: "item", id: "item.dense-bandage" },
      { type: "item", id: "item.field-kit" },
      { type: "item", id: "item.cellar.fancy-cheese" },
      { type: "item", id: "item.cellar.foamy-mirage-bottle" },
      { type: "item", id: "item.loot-v1-c001" },
      { type: "item", id: "item.loot-v1-c002" },
      { type: "item", id: "item.loot-v1-c008" },
      { type: "item", id: "item.loot-v1-c012" },
      { type: "item", id: "item.loot-v1-c015" }
    ]
  },
  {
  ...
  {
    id: "custom-guild-charter",
    categoryId: "guilds",
    title: "Ґільдійний статут",
    source: "з канцелярської теки, яку писар нарешті підписав",
    body: "Ґільдія в Квестарні — це спільна назва, герб і список до восьми пригодників, а не спільний гаманець чи власна ватага. Засновникові потрібен 7 рівень до першого реморту, або 3 після нього, 587 золота й вільний семиденний засновницький облік. Публічний шлях починається в «🪺 Гнізді ґільдій» при Спуску до Низу: там читають умови, відкриті профілі й починають покроковий бланк. Власний статут повертається з картки персонажа, а запрошення передають приватним посиланням. Після підтвердження статут чекає сім днів: його активує прийняття запрошення першим окремим учасником. Голова керує описом, ролями й передачею проводу; старшин може бути двоє. Членство памʼятає пригодника між ремортами.",
  },
  {
    id: "custom-guild-glory-book",
    categoryId: "guilds",
    title: "Книга слави",
    source: "з книги, яку писар тримає в Гнізді ґільдій і нікому не дає виправляти олівцем",
    body: "Чинна ґільдія веде один тижневий журнал звичайних спільних походів до Низу. Підтримка, лікування й захист важать нарівні з ударом, а завершення 13/13 лишає ґільдії рівно +13 Слави. Корчмарський обхід, інші денні квести й особисті справи Слави не дають. У «📜 Книзі слави» можна звірити загальну Славу й поточну тижневу Першість ґільдій, але не пригодників: імена учасників, ролі, особисті внески й приватні години писар не показує. Слава нічого не купує, не підсилює бій і не перетворюється на ґільдійний досвід — вона лише доводить, що книга цього разу не загубила сторінку.",
  },
  {
    id: "custom-referral-call",
    categoryId: "customs",
    title: "Поклик до Квестарні",
    source: "з Дошки корчми, під поштовою щілиною без ґільдійного герба",
    body: "Поклик — це особистий папірець для нового пригодника, а не ґільдійне запрошення й не наказ. Новачок сам погоджується або йде власною дорогою. Якщо погоджується, Квестарня памʼятає звʼязок між пригодниками, Хроніки один раз записують прибуття, а корчмар згодом сам складає запрошувачеві заслужені припаси. Писар не показує за цим записом чужих місцин, справ, торб, статків чи ґільдії й дуже просить не питати, скільки разів він перевірив печатку.",
  },
  {
