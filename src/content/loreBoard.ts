...
export const loreEntries: readonly LoreEntry[] = [
  ...
  },
  {
    ...
    title: "Бюрокромант",
    source: "з навчальної полиці класів",
    body: "Бюрокромант знерухомлює ворогів формами, печатками й дуже серйозним виглядом. У бою «📄 Форма 13-Б» змушує кожного ворога тимчасово виглядати як помилка заповнення, а під час збору до Старшого Брата Бочки «Протокол 13-Б» може прийняти перший персональний ляпас по підписанту.",
