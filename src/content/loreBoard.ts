...
export const loreEntries: readonly LoreEntry[] = [
  ...
  },
  {
    ...
    body: "Чинна ґільдія веде один тижневий журнал звичайних спільних походів до Низу. Підтримка, лікування й захист важать нарівні з ударом, а тринадцята печатка лишає ґільдії 13 Слави, яку не можна витратити. У «📜 Книзі слави» можна звірити загальну Славу й поточну тижневу Першість ґільдій, але не пригодників: імена учасників, ролі, особисті внески й приватні години писар не показує. Слава нічого не купує, не підсилює бій і не перетворюється на ґільдійний досвід — вона лише доводить, що книга цього разу не загубила сторінку.",
  },
  {
