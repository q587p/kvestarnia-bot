...
export const loreEntries: readonly LoreEntry[] = [
  ...
  },
  {
    ...
    body: "Ґільдія в Квестарні — це спільна назва, герб і список до восьми пригодників, а не спільний гаманець чи власна ватага. Засновникові потрібен 5 рівень, або 3 після першого реморту, 587 золота й вільний семиденний засновницький облік. Публічний шлях починається в «🪺 Гнізді ґільдій» при Спуску до Низу: там читають умови, відкриті профілі й починають покроковий бланк; «🏰 Ґільдії» в головному меню лишається приватним шляхом відновлення. Запрошення передають приватним посиланням. Після підтвердження статут чекає сім днів: його активує прийняття запрошення першим окремим учасником. Голова керує описом, ролями й передачею проводу; старшин може бути двоє. Членство памʼятає пригодника між ремортами, але звичайні ватаги та битви живуть за своїми правилами.",
  },
  {
