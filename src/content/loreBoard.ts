...
export const loreEntries: readonly LoreEntry[] = [
  ...
  },
  {
    ...
    source: "з навчальної полиці класів",
    body: "Козак-характерник дивиться на проблему так, що проблема сама шукає собі іншу пригоду. У бою «👁 Степовий косий погляд» проходить по всіх ворогах і стишує їхню певність, не підвищуючи голосу.",
