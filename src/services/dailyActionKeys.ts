...
export const ADVENTURE_CHOICE_KEY = "adventure.choice-mvp";
export const ADVENTURE_CHOICE_REROLL_KEY = "adventure.choice-mvp.reroll";
export const MIMIC_SHAWARMA_COMBAT_PROBE_KEY = "combat.mimic-shawarma.probe";
export const HUNT_BOARD_CONTRACT_KEY = "combat.hunt-board.contract";
...
export const PROBLEM_QUEST_23_ISSUED_KEY = "quest.problem-chain.23.issued";
export const PROBLEM_QUEST_23_REWARD_KEY = "quest.problem-chain.23.reward";
export const PROBLEM_QUEST_42_ISSUED_KEY = "quest.problem-chain.42.issued";
