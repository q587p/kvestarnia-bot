...
- Removed the nine-ability GroupCombat allowlist and froze all 132 canonical authored monster abilities in the immutable production-v1 catalog. Canonical self/ally/all-player damage, healing, shields, buffs, debuffs, cooldowns and once-only markers now execute through their authored recipes, including both ledger-boar specials; unknown or malformed persisted definitions still fail strict validation.
