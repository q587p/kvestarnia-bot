...
- Equivalent and closely related help aliases now share compact rows: `/hero, /profile`, `/bestiary, /monsters`, and `/gear, /equip`, while every command remains discoverable.
...
- Final repository verification passed 316 unit files / 3951 tests and 23 integration files / 552 tests, including a cache-disabled unit repeat, all 56 PartyBoss reducer tests, and the five targeted simulation corridors. Target deployment, migration application, flags, backup/restore, Telegram QA and observation remain unverified.
