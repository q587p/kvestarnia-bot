...
- Added isolated Prisma query-event tests proving Friday budgets of one statement without a character and at most three with a character, grouped Fight/problem budgets of one to five statements, a complete full-source marker reduction from 75 reads to 10, and a fresh nonterminal fight-turn reduction from 48 reads / 51 total statements to 27 / 30. Fixtures with 10,000 irrelevant combat or DailyAction rows keep the same statement counts, and valid win counting stops at 93.
