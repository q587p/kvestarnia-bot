...
- Completed Big Barrel Brother result cards opened without a matching participant viewer now show a general raid summary instead of leaking the first rewarded participant's XP, gold and item grants; participant cards label the payout as `Ваша винагорода за рейд`.
