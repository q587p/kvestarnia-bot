...
- Made GroupCombat enemy focus match the Big Barrel contract: the living party leader is targeted initially, then the participant with the most actual damage in the previous resolved turn, with stable roster-order ties. Active cards mark `🎯 ціль ворогів`, and recaps announce focus changes.
