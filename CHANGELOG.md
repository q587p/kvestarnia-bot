...
- Preserved authored monster-special semantics in GroupCombat through an explicit supported contract: self/ally healing, shields, defensive and outgoing-damage buffs, all-player damage/debuffs and single-player damage/burn now keep their real targets and effects. Unsupported specials are excluded to basic attacks, and persisted unsupported production loadouts fail strict validation instead of becoming unrelated player damage.
