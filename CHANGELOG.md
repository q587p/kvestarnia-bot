...
- The overview now explicitly surfaces two ready handoffs that players otherwise missed: `🪧 Три справи на найближчий час` when the regular three-case choice is waiting, and `Справа не до миші` for its offered, paused and bottle-turn-in stages.
