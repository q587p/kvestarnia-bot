  ...
  it("renders completed result with reward and no exact timestamp", () => {
    ...
    expect(text).toContain(
      [
        ...
        "",
        "Пересічні Пригодники: сирна пастка стає доказом, що дипломатія інколи пахне краще за меч. Корчма отримує ще одну людиськову історію, яку ніхто не просив, але всі слухають. Сила тут не головна, але дуже переконлива в примітках.",
        "",
        "<b>+2 XP",
        "+1 золота</b>"
      ].join("\n")
