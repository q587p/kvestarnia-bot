...
describe("class noncombat presenter", () => {
  ...
  it("keeps Varenyk rank internal and shows only the applied cost and effects", () => {
    ...
    expect(preview).toBe([
      ...
      "Одразу до <b>+5 HP</b>.",
      "Далі <b>+2 HP і +2 мани</b> щохвилини поза боєм або кожен хід в бою (це забирає хвилину дії).",
      "",
    ...
    expect(preview).toContain("щохвилини поза боєм або кожен хід в бою");
    expect(preview).toContain("(це забирає хвилину дії)");
  ...
  it("formats a fresh self-feeding result like other class support outcomes", () => {
    ...
    expect(text).toBe([
      ...
      "",
      "😋 Стан: <b>Ситий</b> ще <b>13 хв</b> — <b>+1 HP</b> і <b>+1 мани</b> щохвилини поза боєм або кожен хід в бою (це забирає хвилину дії). Видно в персонажі поруч з іншими станами.",
      "",
  ...
  it("groups Varenyk statuses and pair waits by recipient without repeating names", () => {
    ...
    expect(text).toContain([
      "👤 <b>Ви</b>, ситий ще <b>12 хв</b> (<b>+3 HP / +3 мани</b>). Знову через <b>92 хвилини</b>.",
      "👤 <b>Kyjivan BooksDragon</b>, ситий ще <b>13 хв</b> (<b>+3 HP / +2 мани</b>). Знову через <b>93 хвилини</b>."
    ].join("\n"));
