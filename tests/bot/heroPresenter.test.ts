...
describe("hero presenter", () => {
  ...
  it("shows the Sated effect with bold values and no embedded recovery notice", () => {
    ...
    expect(text).toContain("😋 Стан: <b>Ситий</b> ще <b>13 хв</b>\n<b>+2 HP</b> і <b>+2 мани</b> щохвилини поза боєм або після завершення бойового обміну (кожен забирає хвилину дії).");
