...
describe("hero presenter", () => {
  ...
  it("shows the Sated effect with bold values and no embedded recovery notice", () => {
    ...
    expect(text).toContain("😋 Стан: <b>Ситий</b> ще <b>13 хв</b> — <b>+1 HP</b> і <b>+1 мани</b> щохвилини поза боєм або після власного ходу в бою (кожне бойове відновлення додатково скорочує дію на хвилину).");
