...
- Головна reply-клавіатура має кнопку `👥 Учасники`, яка відкриває той самий зріз, що й `/online`: хто поруч у поточній місцині та хто у поточному рейді/пригоді, якщо герой зараз у такій сцені.
