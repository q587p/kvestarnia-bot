...
- Після натискання `🍺 У рейд на бочку` герой має входити в pending raid на випадкові 1–3 хвилини, як і каже корчмар.
- Поки рейд триває, `/quest`, `/adventure`, `/fight`, `/hunt` та інші пригодові дії мають відповідати станом на кшталт «ви зараз у рейді, дочекайтесь завершення».
- Після завершення pending raid бот видає підсумок і винагороду; повторні callback-и все одно лишаються ідемпотентними.
- Цей стан має перейти в майбутню session/raid model, а не бути лише затримкою в presenter text.
