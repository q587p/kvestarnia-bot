...
- Один рейдовий відтинок триває годину й перемикається на 23-й хвилині за київським корчемним часом; у межах одного відтинку видається детерміновано-рандомна винагорода `18-26 XP` і `8-14 золота`.
...
- У 0.0.15 рейд також видає `item.apron-of-foam-resistance` як перший reachable обладунок для тулуба й один детермінований дрібний бочковий trophy item; у 0.0.16 XP/золото стали вищим deterministic roll-ом, але бойова математика не змінилась.
