...
- `location.korchma.hall` — Зала корчми, головний hub із переходами до столу зі справами, шинку, бочки, дошки вістей, підвалу й надвір.
...
- `0.0.28` додає на цю саму надвірну табличку блок «Видатні жителі»: для кожного відомого рівня показуються перший, другий і третій персонаж, який його досяг.
...
- Підвальна справа відкривається з 2 рівня і лишається новачковою на рівнях 2-3. До 2 рівня hub показує locked-рядок без кнопки `🧹 У підвал`; з 4 рівня retired-рядок підказує `Справа не до миші`, а кнопка `🧹 У підвал` веде в старшу підвальну справу. Старі мишачі callback-и не видають reward і не переносять presence у підвал після gate.
