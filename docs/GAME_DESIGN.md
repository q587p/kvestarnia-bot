...
- Один рейдовий відтинок триває годину й перемикається на 23-й хвилині за київським часом; у межах одного відтинку видається `+7 XP` і `+5 золота`.
- Нові старти призупинені з 04:00 до 08:00 за київським часом: у корчмі переоблік піни, підозр і того, хто знову поставив бочку не за формою.
