...
- У 0.0.11 натискання `🍺 У рейд на бочку` запускає pending raid на випадкові 1–3 хвилини: герой «у рейді», а `/quest`, `/adventure`, `/fight`, `/hunt`, `/cellar` та відповідні callback-и тимчасово відповідають блокувальним станом.
