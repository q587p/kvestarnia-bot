...
- Це не покроковий бій, не loot loop і не inventory; лише перша коротка пригода з ідемпотентною винагородою.
...
Tavern і adventure rewards оновлюють XP, золото й рівень через спільний deterministic helper.
