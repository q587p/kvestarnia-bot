...
- Майбутній борг: `Тринадцять дрібних проблем` і підвальні справи мають здаватися корчмарю в `location.korchma.bar`, а не віддалено біля Столу зі справами чи з підвалу.
