...
- Один рейдовий відтинок триває годину й перемикається на 23-й хвилині; у межах одного відтинку видається `+7 XP` і `+5 золота`.
- Нові старти призупинені з 04:00 до 08:23: у корчмі переоблік піни, підозр і того, хто знову поставив бочку не за формою.
