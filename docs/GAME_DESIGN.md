...
- Щоб onboarding не вивалював усе одразу, Дошка полювання відкривається з 3 рівня. До цього hub показує locked-рядок без кнопки `🏹 До дошки`, а direct `/hunt` або старий hunt callback не створює contract ledger і не видає reward. Стартові шаурма й fight probe лишаються новачковими справами до 3 рівня включно; з 4 рівня hub показує retired-рядок без action-кнопок і веде героя до старших справ.
...
- Доступна до 3 рівня включно; з 4 рівня це retired навчальна справа без action-кнопок і без reward claim.
