...
- [ ] Якщо квест має runtime-вибір методу, він відповідає `docs/design/quest-resolution-variety.md`, `docs/design/quest-skills-and-checks.md` і має scene/race/class/signature coverage або явний виняток.
...
- [ ] Для корчмаря є щонайменше 6–10 різних реплік на повторному вході; selector не зациклюється, а короткі жарти на кшталт «Корчма пам’ятає ваші кроки й не просить вибачень.» мають сусідів, а не клонів.
