...
- **Вареник-мант** (`class.varenyk-mancer`) — primary stat `intelligence`. Керує тістом і від 3 рівня може нагодувати себе або активного пригодника поруч, лишивши короткий стан `😋 Ситий` із малим HP/mana recovery.
