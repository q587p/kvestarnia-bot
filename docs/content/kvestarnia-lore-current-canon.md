...
- **Вареник-мант** (`class.varenyk-mancer`) — primary stat `intelligence`. Керує тістом і від 3 рівня може нагодувати себе або активного пригодника поруч: HP підбадьорюється одразу, а короткий `😋 Ситий` потім підтримує HP і ману щохвилини поза боєм або після власного ходу в бою.
