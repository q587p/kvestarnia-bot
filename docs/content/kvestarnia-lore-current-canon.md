...
- **Бюрокромант** (`class.bureaucramancer`) — primary stat `intelligence`. Знерухомлює ворогів формами, печатками й дуже серйозним виглядом; перед рейдом на Старшого Брата Бочки може відкрити вузький Протокол 13-Б для персональних претензій підписантів.
