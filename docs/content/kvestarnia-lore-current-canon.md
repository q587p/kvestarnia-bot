...
`📨 Поклик до Квестарні` живе на Дошці корчми й через `/invite`, але не є
окремою presence-місциною. Це добровільний public first-touch папірець для
справді нового пригодника, окремий від приватних адресних ґільдійних запрошень.
Після автоматичного прийняття поклику Хроніки один раз називають прибулого й запрошувача; progress,
припаси та приватні дані публічно не показуються. Звʼязок памʼятає User між
restart/remort і не створює guild membership.
...
- **Книга слави** — чинна ґільдія складає звичайні спільні походи до Низу в одну тижневу справу; підтримка рахується нарівні, завершення лишає 13 незатратної ґільдійної Слави, а дві guild-only дошки порівнюють лише ґільдії, без особистої зверхности, бойової сили, спільної скарбниці чи окремого ґільдійного бою.
