...
Перший slice:
- точка входу у бійцівському кутку після стабілізації `0.1.x`, до справжніх duel invites;
- допельґанґер копіює расу, клас, титул і базові класові/бойові гачки героя;
- розвʼязання може використовувати ті самі effective stats / equipment summary, що й майбутні дуелі, але без винагород або з тренувальним результатом без винагород;
- результат має бути replay-safe і короткий: тренування, висновок корчмаря, можливо, жарт про те, що бити себе в дзеркало юридично простіше;
