...
8. Очікування: екіпіровані, priced power/effect, protected, story і безцінні манатки зʼявляються як selectable, якщо вони є known owned items; можна обрати до 5 item id, і саме вони мають перейти в нове коло.
9. Натисни confirm.
