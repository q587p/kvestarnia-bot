...
14. Очікування: side surface відкривається й не просуває бій потайки; пригодові маршрути на кшталт `Квести` чи `Корчма` все ще повертають до бою.
15. Натисни `Відступити` або доведи бій до завершення.
16. Очікування: завершений стан стабільний, action-кнопки зникають, повторні натискання не відкривають бій заново; натомість видно кнопки `⚔️ Новий бій`, `📋 До справ`, `🍺 До зали`.
