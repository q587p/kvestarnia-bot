...
14. Loss/flee/expired не видають full victory reward і не збільшують видимий progress Korhmar problem chain.
15. Перемога має збільшити видимий прогрес поточного problem-chain етапу, якщо це звичайний старший бій, а не `/spar`.
16. Коли поточний етап готовий, бій не має auto-claim reward: Стіл зі справами показує `🍺 До Корчмаря`, а здача в Шинку видає одноразову нагороду й наступний етап зі свіжим лічильником.
