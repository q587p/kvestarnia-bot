...
25. У `Ярус I: Сутерени Корчми` перевір лівий/прямий/правий проходи: повторне відкриття того самого проходу до протермінування має показати того самого монстра, інший прохід може мати власну підозрілу тінь, `Атакувати` має почати саме показаного монстра, а стара/протермінована кнопка має оновити preview з коротким поясненням замість мовчазного старту іншого бою.
