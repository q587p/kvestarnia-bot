...
7. У локальному режимі виклич `/dev_adventure_reset` і перевір, що `/adventure` знову дозволяє обрати справу в цьому самому вікні.
...
- `/dev_adventure_reset` — у локальному режимі скидає поточний 93-хвилинний вибір пригоди для швидкого ручного тесту.
