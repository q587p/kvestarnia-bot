...
14. Іншим персонажем відкрий Шинок і прийми/відхили запропонований кухоль; повторні accept/decline callback-и не мають створювати другий drink state.
15. Відкрий `💰 Продати манатки` з міксом придатних, екіпірованих, priceless/protected і zero-value речей.
16. Вибери одну одиницю, кілька різних речей і `Усе придатне`; підтвердження має показувати basket-level payout, а виключені речі не потрапляють у selection.
17. Перед confirm зміни екіпірування або кількість вибраної речі.
18. Очікування: sale confirm повертає stale-selection без списання речей і без додавання золота.
19. Підтвердь валідний sale і повтори callback: речі та золото змінюються тільки один раз.
