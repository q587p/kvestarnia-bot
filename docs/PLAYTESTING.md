...
2. Open `/equipment`, `/gear` or `/equip`; verify all seven slots appear: `Зброя`, `Друга рука`, `Голова`, `Тулуб`, `Ноги`, `Аксесуар`, `Інструмент`, and the empty `Друга рука` copy/icon does not imply a shield-only slot.
