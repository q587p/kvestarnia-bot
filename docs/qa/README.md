...
- [`0.4.4-guild-foundation-qa.md`](0.4.4-guild-foundation-qa.md) — three-account creation, invitations, roles, remort, restart, privacy, party/combat isolation, flag and rollback matrix; manual Telegram evidence remains pending.
