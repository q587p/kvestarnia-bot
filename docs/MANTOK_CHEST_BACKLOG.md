...
Якщо у коді вже є item value/score, використовувати її. Якщо ні, стартова формула:

```text
qualityRank: common=1, uncommon=2, rare=3, epic=4, legendary=5
itemScore = level * 100 + qualityRank * 25
...
- invalid batch sizes: `4`, `6`, duplicates;
