...
- `0.1.6` extends the Korhmar/Shynok problem wrapper into explicit `13 -> 23 -> 42 -> 93` stages: each new stage is issued through the bar, counts only fresh ordinary won solo fights after its issue timestamp, and keeps doppelganger training out of quest progress.
