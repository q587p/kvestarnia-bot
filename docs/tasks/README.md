...
- None. The latest shipped version task is [0.2.24-mantok-balance-audit.md](0.2.24-mantok-balance-audit.md).
...
- [0.2.24-mantok-balance-audit.md](0.2.24-mantok-balance-audit.md) — Mantok balance audit after the slot foundation, generated Loot Expansion v1 slot/effect tuning, cheap authored trophy-power guard and focused combat/equipment regressions.
