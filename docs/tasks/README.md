...
- None. The latest shipped version task is [0.2.26-dice-poker-rework.md](0.2.26-dice-poker-rework.md).
...
- [0.2.26-dice-poker-rework.md](0.2.26-dice-poker-rework.md) — shipped replacement for confusing `🎲 Кості` with quick dice poker, 13-turn scorecard poker, compact rules, legacy Kosti refund handling and replay-safe bounded stake settlement.
...
- [0.2.x-dice-poker-rework.md](0.2.x-dice-poker-rework.md) — archived draft activated as [0.2.26-dice-poker-rework.md](0.2.26-dice-poker-rework.md).
