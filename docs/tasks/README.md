...
- [0.3.6-bureaucramancer-personal-protocol-13b.md](0.3.6-bureaucramancer-personal-protocol-13b.md) — shipped narrow Bureaucramancer `📄 Протокол 13-Б` Big Barrel recruiting action: one protocol per session, count-only signatures, and per-signer first personal boss attack protection.
