...
- [0.2.x-consumable-manatka-uses.md](0.2.x-consumable-manatka-uses.md) — draft follow-up for giving coffee/tea-style consumable manatky real one-use actions and `Разові` visibility without implementing it in `0.2.31`.
