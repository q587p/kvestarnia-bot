...
- [0.3.1-turn-based-duel-tournaments-rewards.md](0.3.1-turn-based-duel-tournaments-rewards.md) — fixed daily/weekly/monthly turn-based duel tournaments with repeated-opponent downweighting, replay-safe Korchma-funded top-three prize chests, bounded unclaimed reward lookback, Holocene period display, combat-style turn-based duel cards, stored duel journals and Chronicles recognition for claims only.
