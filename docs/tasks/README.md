...
- [0.2.x-mantok-set-synergies-foundation.md](0.2.x-mantok-set-synergies-foundation.md) — Mantok equipment set-synergy foundation on top of shipped slot coverage.
...
- [0.2.x-mantok-set-synergies-foundation.md](0.2.x-mantok-set-synergies-foundation.md) — active Mantok set-synergy foundation with 13 stat-only set families, live set progress and additive high-level monster loot.
