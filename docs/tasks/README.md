...
- [0.3.11-fight-turn-daily-korchma-read-path-reduction.md](0.3.11-fight-turn-daily-korchma-read-path-reduction.md) — planned evidence-driven reduction of the unconditional Yeger read on persistent Fight turns and the repeated full Fight/Daily Korchma reads inside main-menu quest markers, with bounded attribution and no gameplay change.
