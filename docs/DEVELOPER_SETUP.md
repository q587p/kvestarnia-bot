...
Коли `NODE_ENV` не `production`, бот приймає допоміжні команди для швидкого плейтесту:
...
Ці команди не потрапляють у бокове меню Telegram і мають лишатися вимкненими в production.
