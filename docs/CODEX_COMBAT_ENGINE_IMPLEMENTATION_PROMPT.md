...
Use this prompt after `docs/COMBAT_ENGINE_DESIGN.md` is merged or as a branch stacked on top of it.

## Goal

Implement the first real solo PvE combat engine for Квестарня without losing the design constraints from `docs/COMBAT_ENGINE_DESIGN.md`.
...
- `docs/COMBAT_ACTION_VARIANTS_PLAN.md` if present
