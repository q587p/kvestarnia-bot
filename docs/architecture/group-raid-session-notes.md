...
## Where current equipment must stay out of this

- Equipment shell and starter gear should not affect minimum participant counts.
- Equipment shell and starter gear should not modify action success chance.
- Equipment shell and starter gear should not alter reward calculation.
- Equipment shell and starter gear should not grant special raid-only slots yet.
