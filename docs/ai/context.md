...
- Current version: `0.3.13` — location-safe Bard/quest encounters, single-confirmation duel invites with ordered turn-duel startup, crossed-out quest checklists and readable Fighting Corner claim paragraphs.
