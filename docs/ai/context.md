...
- Current version: `0.3.13` — location-safe Bard/quest encounters, non-mutating duel details with idempotent ordered turn-duel startup, formatted Fighting Corner rules, crossed-out quest checklists, shared readable completed-reward paragraphs and exact-once achievement-aware Nyz search material finds.
