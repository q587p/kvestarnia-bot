...
- Active implementation target: `0.4.6 — Referral Foundation`, branching from merged `main` `4eeddf16` after PR #190 / Guild Foundation and PR #193 / Activation Chronicles hotfix. Guild code and replay-safe public `guild.created` are merged; exact-head three-account guild Telegram QA, target migration/flag/deploy evidence and the abandoned-leader runbook remain unproven.
...
- `docs/tasks/0.4.6-referral-foundation.md`, `docs/design/referral-system.md` and `docs/qa/0.4.6-referral-foundation-qa.md` — current release contract, persistence design and pending six-account Telegram QA; `docs/tasks/0.4.5-guild-foundation.md` retains the merged guild contract and separate pending rollout evidence.
