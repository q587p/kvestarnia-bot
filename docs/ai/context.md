...
- Current version: `0.3.13` — location-safe Bard/quest encounters, single-confirmation duel invites with ordered turn-duel startup, and crossed-out quest checklists.
