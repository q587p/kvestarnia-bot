...
- The underlying `0.4.1` restart-safe 2–3 player versus 2–3 enemy proof remains available only behind `GROUP_COMBAT_PROOF_ENABLED` outside production.
  ...
  proof/presenter maxima are `20,150` state, `1,523` terminal-card fixture and `46` GroupCombat action callback; the rolling production 3×6 journal measured `52,595`, with initial 3×6 state/card at `14,350`/`536`. The 24-case
