...
- The underlying `0.4.1` restart-safe 2–3 player versus 2–3 enemy proof remains available only behind `GROUP_COMBAT_PROOF_ENABLED` outside production.
  ...
  proof/presenter maxima are `20,212` state, `2,607` terminal-card fixture and `53` callback; the complete production 3×6 journal measured `44,066`. The 24-case
