...
Use these docs for completed phases, imported audit packages and old planning records. They are useful context, not active scope, unless a current task links to them explicitly.
...
Historical docs should not be silently edited to match current implementation unless the task is explicitly a docs reconciliation or archive cleanup.
