...
| Old Altar is documentation-mature | `docs/tasks/0.2.x-old-altar-blessings-mvp.md`; `docs/design/old-altar-blessings.md`; balance/copy/QA/prompt siblings |
...
| Greeting effect is undecided | four alternative directions in `docs/tasks/0.2.x-nearby-greeting-buff.md` |
...
| Resale threshold draft conflicts | `>= 93` and `> 93` both appear in `docs/tasks/0.2.x-shynok-resale-and-korchmar-recycling.md` |
