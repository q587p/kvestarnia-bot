...
Task:
Integrate the corrected 0.3.x closeout / 0.4.x party, guild and bounded
social-economy catch-up docs delta.
...
- Delta archive: kvestarnia-0.3x-to-0.4x-roadmap-audit-v2-12026-07-20.zip
