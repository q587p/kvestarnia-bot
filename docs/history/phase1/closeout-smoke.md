...
Цей checklist — фінальна ручна рамка для `0.1.0` Phase 1 closeout. Він доповнює [docs/operations/playtesting.md](../../operations/playtesting.md), [docs/history/phase1/0.1-transition.md](./0.1-transition.md) і [docs/history/phase1/release-notes.md](./release-notes.md), але не замінює unit/integration tests.
