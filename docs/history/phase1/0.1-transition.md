...
Детальний smoke живе в [docs/history/phase1/closeout-smoke.md](./closeout-smoke.md).
...
- `docs/product/roadmap.md`, де Phase 1 позначено закритою, `0.1.x` — стабілізаційною лінійкою, а Phase 2 — Social Combat & Interactions;
- `docs/history/backlog/next-implementation-backlog.md` з top-order для `0.1.x`;
- `docs/README.md` і `docs/history/phases/phase2/planning/*` як новий planning index для duel invites, trading/gifting, `/remort`, item tags, multi-enemy and party combat;
- `docs/operations/playtesting.md` або окремий smoke doc із closure route;
- `docs/balance/notes.md` із відомими не-фінальними балансними припущеннями.
