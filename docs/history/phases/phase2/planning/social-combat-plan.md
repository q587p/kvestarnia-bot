...
Closeout cutline lives in [../../../phase2/mvp-closeout-plan.md](../../../phase2/mvp-closeout-plan.md). After `0.1.24`, the intended next `0.1.x` step is `0.1.25 - Phase 2 MVP Closeout`: a docs/release/smoke milestone with no new gameplay. Expansion work moves to [../../../phase2/deferred-0.2.md](../../../phase2/deferred-0.2.md).
...
- [duels-and-invites.md](duels-and-invites.md)
- [trading-and-gifting.md](trading-and-gifting.md)
- [item-tags-and-consumables.md](item-tags-and-consumables.md)
- [unstable-balance-principles.md](unstable-balance-principles.md)
