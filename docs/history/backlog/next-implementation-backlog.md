...
- [PHASE1_RELEASE_NOTES.md](../phase1/release-notes.md)
- [PHASE1_CLOSEOUT_0_1_TRANSITION.md](../phase1/0.1-transition.md)
- [PHASE1_CLOSEOUT_SMOKE.md](../phase1/closeout-smoke.md)
- [phase2/SOCIAL_COMBAT_PLAN.md](../phases/phase2/planning/social-combat-plan.md)
- [phase2/DUELS_AND_INVITES.md](../phases/phase2/planning/duels-and-invites.md)
...
Future task doc: [0.2.x-dense-bandage-field-kit.md](../../tasks/archive/0.2.x-dense-bandage-field-kit.md).
...
- Видимість і backend-доступ до advanced supplies відкриваються лише після завершення другої Єгерської дошки: `YEGER_UNQUIET_TRIAL_SECOND_TARGET = 17` неупокоєних проблем.
...
Future source doc: [TAVERN_SOCIAL_GAMES.md](../../backlog/tavern-social-games-backlog.md).
...
Canonical design doc: [SUPPORT_JAR_LIVE_STATUS.md](../../operations/support-jar-live-status.md).
...
Канонічний planning doc: [NONCOMBAT_TECHNIQUES.md](../../design/noncombat-techniques.md). Корчма історично була місцем неофіційної культури: пісні, жарти, сатиричні куплети, бандура, скрипка, ложки, живий гумор і раптові виступи. У Квестарні це має стати не лекцією, а кнопкою з ризиком, короткою сценою й корчмарським висновком.
...
- docs source: `docs/backlog/mantok-chest-backlog.md`.
...
- корчемні ігри з `docs/backlog/social-actions-backlog.md`: дуже прості карти/шашки на 2–4 кроки з opt-in викликом nearby пригодника, легким випадковим розвʼязанням, presence flavor і косметичним/соціяльним результатом без бойової переваги;
