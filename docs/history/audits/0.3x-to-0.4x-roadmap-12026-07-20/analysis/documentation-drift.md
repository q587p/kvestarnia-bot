...
| `docs/architecture/technical-plan.md` | party/raid tables called future; item instances implied before every new sale/trade-like sink | implemented group delta + separate generic model + bounded aggregate-stack cutline |
| `docs/tasks/README.md` | old drafts mixed with active; HP recovery “queued”; altar/greeting/food/consumables/resale have no current address | planned sequence + shipped/deferred/superseded/source labels and split catch-up tasks |
...
- змішати food status, carried item, resale listing і recycling batch в один PR;
- назвати shipped 42% sale «deferred» або вимагати item instances без per-copy
  mutable identity.
