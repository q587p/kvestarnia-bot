...
- Old Altar runtime, greeting buff, food, generic consumables, public resale і
  Korchmar recycling — уже мають явну catch-up queue, див.
  [`social-economy-catchup.md`](social-economy-catchup.md);
- item instances, two-sided trade/market;
- seasons, guild wars, Mini App.

Важливе уточнення: базовий player-to-Korchmar sale не deferred — він shipped у
`0.1.24`. Старий `later 0.3.x` promise стосувався public resale stock і neutral
recycling. Так само medical one-use items shipped, але generic coffee/tea/beer
catalog і take-away shelf — ні.

## Старий architecture debt, який треба памʼятати

`docs/tasks/archive/0.2.x-combat-application-decomposition.md` містив умовний gate:
