# Release-Specific Manual QA Evidence

These release-specific smoke sections were split from the reusable
[current playtesting runbook](../../../operations/playtesting.md) during the repository-hygiene cleanup.
They preserve the original headings and checks as historical evidence; they are not a claim that
the corresponding Telegram QA was completed.
...
Канонічний closeout gate для бойово-соціяльного зрізу живе в [`docs/history/phase2/closeout-smoke.md`](../../phase2/closeout-smoke.md), а підсумок релізу — в [`docs/history/phase2/mvp-release-notes.md`](../../phase2/mvp-release-notes.md).
...
Це поточний короткий Definition of Done для закритої Phase 1 петлі. Детальний ручний маршрут живе в [`docs/history/phase1/closeout-smoke.md`](../../phase1/closeout-smoke.md):
