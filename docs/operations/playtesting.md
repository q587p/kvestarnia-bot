...
скопійований прапорець. Перевір межу заснування на 7 рівні до першого реморту
й на 3 після нього, create/duplicate confirm, нормалізовану
...
- `/dev_reset_korchma_round [random|hit|miss|forced-pity]` — у локальному режимі скидає поточний київський день Корчмарського обходу; режими дозволяють окремо відтворити звичайний, гарантовано влучний, гарантовано невдалий і примусовий pity-результат.
