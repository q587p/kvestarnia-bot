...
3a. Лиш активний хід Допельґанґера до дедлайну, потім окремо відкрий `/spar`, callback вибору режиму та `📜 Журнал бою`: кожне ліниве terminal settlement має зарахувати тренування рівно раз, а повторні journal/view callback-и не мають дублювати прогрес чи сповіщення.
...
9. Виконай remort: старе життя має лишитися в історії, нова справа — замкненою до 3 рівня, а потім доступною заново; повторний claim не має складати друге мило.
