...
3. Після прийняття заверши тренування, миттєву й покрокову дуелі в іншому порядку; одну дію програй, а в покроковій дуелі проведи щонайменше один раунд.
...
6. Спробуй забрати нагороду поза Столом, потім забери її за Столом; запиши точні XP, золото та Іскрокамінь, повтори callback і переконайся, що нагорода не дублюється.
...
8. Виконай remort: старе життя має лишитися в історії, нова справа — замкненою до 3 рівня, а потім доступною заново.
9. Локально виконай `/dev_reset_fighting_corner_quest` і повтори current-life flow; у production команда не має реєструватися або зʼявлятися в `/dev_help`.
