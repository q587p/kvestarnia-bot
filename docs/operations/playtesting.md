...
6a. With at least two participants in one recruiting group, verify the leader no longer sees `🧹 Скасувати збір`; `🔎 Оновити` sits beside `Готовий` / `Готова` / `Готові` or `Зачекайте`; and `🛢️ Почати рейд` remains the final button.
