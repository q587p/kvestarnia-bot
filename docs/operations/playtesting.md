...
3a. Лиш активний хід Допельґанґера до дедлайну, потім відкрий `/spar` і повтори через callback вибору режиму: ліниве terminal settlement має зарахувати тренування рівно раз.
...
6. Спробуй забрати нагороду поза Столом, потім забери її за Столом. На 3 рівні перевір рожеве мило-інструмент і один Іскрокамінь; на 4+ — мило й два Іскрокамені. Запиши точні XP/золото, повтори callback і переконайся, що нічого не дублюється.
