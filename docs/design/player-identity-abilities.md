...
| Вареник-мант | `🥟 Кипляча начинка` (`skill.boiling-filling`): all enemies plus small self/ally fallback heal, spell, 4 мани, 2 cooldown. | `0.3.12` `🍽️ Нагодувати`: level 3+ self/active exact-location support with deterministic affordable rank, immediate HP/mana and short `😋 Ситий` sustain outside combat and in durable turns. | Keep food magic scoped; no broad cooking, ingredients or crafting engine. |
