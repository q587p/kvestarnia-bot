...
- `docs/phase2/ITEM_TAGS_AND_CONSUMABLES.md`: one-use bandage shipped; broad item actions later.
...
- `docs/tasks/0.2.x-mantok-equipment-rebalance.md`: important but too broad to take immediately after abilities unless narrowed.
- `docs/tasks/0.2.x-raid-party-session-foundation.md`: correct party prerequisite, not real raid.
- `docs/tasks/0.2.x-party-vs-one-boss.md`: bridge after foundation.
