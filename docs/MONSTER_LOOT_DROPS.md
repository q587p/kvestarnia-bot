...
У `0.0.17` `/hunt` використовує цей mapping дуже вузько: один детермінований щоденний контракт може видати максимум один трофей із відповідного списку, тільки через `daily_actions` і без повної випадкової таблиці здобичі.
