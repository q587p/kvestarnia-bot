...
- [ ] **Add 5 fallback outcome lines for low-level monsters**  
  ...
  Likely files: `src/content/monsterFlavor.ts`, `docs/MONSTER_ENCOUNTER_AUTHORING_GUIDE.md`.  
...
- [ ] **Design a level 2 food-monster mini-pack**  
  ...
  Likely files: `src/content/monsters.ts`, `src/content/monsterLootItems.ts`, `docs/BESTIARY.md`, `docs/MONSTER_LOOT_DROPS.md`.  
...
- [ ] **Design a bureaucracy-monster mini-pack**  
  ...
  Likely files: `src/content/monsters.ts`, `src/content/monsterFlavor.ts`, `docs/BESTIARY.md`.  
...
- [ ] **Add future boss gating rules**  
  ...
  Likely files: `docs/MONSTER_ENCOUNTER_AUTHORING_GUIDE.md`, `docs/HUNT_BOARD_FOLLOWUP_PLAN.md`, пізніше `src/services/huntService.ts`.  
...
- [ ] **Add reward pacing simulation for hunt vs cellar vs barrel**  
  ...
  Likely files: `docs/MONSTER_REWARD_AND_LOOT_BALANCE.md`, future simulation script, balance notes.  
...
- [ ] **Add future group hunt entrance copy**  
  ...
  Likely files: `docs/HUNT_BOARD_FOLLOWUP_PLAN.md`, `docs/MONSTER_ENCOUNTER_AUTHORING_GUIDE.md`.  
...
- [ ] **Add group chat monster spam moderation notes**  
  ...
  Likely files: `docs/SECURITY_AND_FAIR_PLAY.md`, future group hunt docs.  
...
- [ ] **Prepare equipment-aware encounter consequences**  
  ...
  Likely files: `docs/EFFECTIVE_STATS_AND_EQUIPMENT_EFFECTS_PLAN.md`, future service tests.  
...
- [ ] **Add Ukrainian loot name review pass**  
  ...
  Likely files: `src/content/monsterLootItems.ts`, `docs/CONTENT_STYLE_GUIDE.md`, `docs/MONSTER_LOOT_DROPS.md`.  
...
- [ ] **Expand monster tag taxonomy**  
  ...
  Likely files: `src/content/monsters.ts`, `docs/BESTIARY.md`, `docs/MONSTER_CONTENT_TASK_BACKLOG.md`.  
...
- [ ] **Add monster flavor seed examples**  
  ...
  Likely files: `docs/MONSTER_FLAVOR_ROUTING.md`, `docs/MONSTER_ENCOUNTER_AUTHORING_GUIDE.md`.  
...
- [ ] **Add encounter authoring QA examples**  
  ...
  Likely files: `docs/MONSTER_ENCOUNTER_AUTHORING_GUIDE.md`, `docs/BESTIARY.md`.  
