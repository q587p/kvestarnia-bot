...
Статистика героя не повинна обчислюватися в presenter-ах. Presenter має тільки показувати те, що вже вирішив домен: красиво, коротко й без прихованої математики.
...
- human-readable contribution lines, наприклад:
  ...
  - `Фартух піностійкого героя: +1 виживання`

## Guardrails

### 1. Жодних прихованих змін у `/hero`
Якщо герой бачить бонуси, це має бути явною частиною summary.  
