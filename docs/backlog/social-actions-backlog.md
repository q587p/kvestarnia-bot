...
Canonical planning doc: [TAVERN_SOCIAL_GAMES.md](./tavern-social-games-backlog.md).
...
- `Кості` as Dice Poker after `0.2.26`; the older 2-7 style/sign table is retired unless a future product decision reopens it;
