...
**Files likely to change:**
`src/content/monsters.ts`, `src/content/monsterFlavor.ts`, `src/content/monsterLootItems.ts`, `docs/design/bestiary.md`, `docs/design/monster-loot-drops.md`, `tests/content/monsterFlavor.test.ts`.
