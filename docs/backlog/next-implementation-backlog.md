...
- [PHASE1_RELEASE_NOTES.md](../history/phase1/release-notes.md)
- [PHASE1_CLOSEOUT_0_1_TRANSITION.md](../history/phase1/0.1-transition.md)
- [PHASE1_CLOSEOUT_SMOKE.md](../history/phase1/closeout-smoke.md)
...
Future source doc: [TAVERN_SOCIAL_GAMES.md](./tavern-social-games-backlog.md).
